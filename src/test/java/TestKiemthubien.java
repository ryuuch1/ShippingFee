...
public class TestKiemthubien {

    static Stream<Arguments> provideTestCases() throws Exception {
        List<Arguments> args = new ArrayList<>();

        try (InputStream is = TestKiemthubien.class.getClassLoader()
                .getResourceAsStream("TestcaseKiemThuBien.xlsx")) {
            if (is == null) {
                throw new RuntimeException("Không tìm thấy file TestcaseKiemThuBien.xlsx trong resources");
            }
